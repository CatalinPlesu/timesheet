...
<div class="dropdown dropdown-end dropdown-bottom" id="profile-dropdown">
	<button
	...
	{#if isOpen}
		<ul class="dropdown-content menu bg-base-200 rounded-box z-[1] w-64 p-2 shadow-lg">
			...
			<li>
				<button disabled class="opacity-50 cursor-not-allowed" type="button">
			...
			<div class="divider my-1"></div>
			<li>
				<button onclick={handleLogout} class="text-error" type="button">
					<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
